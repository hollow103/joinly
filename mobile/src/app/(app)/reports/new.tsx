...
const styles = StyleSheet.create({
  ...
  eyebrow: { color: '#B8C7FF', fontSize: 11, fontWeight: '700', letterSpacing: 0.8 },
  title: { color: tokens.color.primaryText, fontSize: 27, fontWeight: '700', lineHeight: 34 },
  target: { color: '#D5DEFA', fontSize: 16, fontWeight: '600' },
  helper: { color: '#D5DEFA', fontSize: 14, lineHeight: 20 },
